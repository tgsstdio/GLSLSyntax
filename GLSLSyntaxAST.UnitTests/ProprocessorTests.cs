...
//			var lengths = new uint[numStrings + numPre + numPost];
//			const string[] strings = new string[numStrings + numPre + numPost];
			//TInputScanner scanner = new TInputScanner (numStrings + numPre + numPost, strings, lengths, numPre, numPost);
//			TInputScanner scanner = null;
//			var intermediate = new TIntermediate ();
//			var infoSink = new TInfoSink ();
//			var parseContext = new TParseContext (scanner, intermediate, infoSink);
...
//			int lastToken = -1;
//			parseContext.setScanner(scanner);
//			ppContext.setInput(scanner, versionWillBeError);
//
